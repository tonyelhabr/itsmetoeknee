...
```{=html}
<div id="taqpmxfwmz" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
...
#taqpmxfwmz thead, #taqpmxfwmz tbody, #taqpmxfwmz tfoot, #taqpmxfwmz tr, #taqpmxfwmz td, #taqpmxfwmz th {
border-style: none;
}
...
#taqpmxfwmz .new_gt_caption {
padding-top: 4px;
padding-bottom: 4px;
}

#taqpmxfwmz .new_gt_title {
color: #FFFFFF;
font-size: 125%;
font-weight: initial;
padding-top: 4px;
...
#taqpmxfwmz .new_gt_bottom_border {
border-bottom-style: none;
border-bottom-width: 2px;
border-bottom-color: #D3D3D3;
}

#taqpmxfwmz .new_gt_col_headings {
border-top-style: none;
...
#taqpmxfwmz .new_gt_column_spanner_outer {
color: #FFFFFF;
background-color: #222222;
font-size: 100%;
font-weight: normal;
...
#taqpmxfwmz .new_gt_column_spanner_outer:first-child {
padding-left: 0;
}

#taqpmxfwmz .new_gt_column_spanner_outer:last-child {
padding-right: 0;
}

#taqpmxfwmz .new_gt_column_spanner {
border-bottom-style: solid;
border-bottom-width: 3px;
border-bottom-color: #FFFFFF;
vertical-align: bottom;
...
#taqpmxfwmz .new_gt_spanner_row {
border-bottom-style: hidden;
}

#taqpmxfwmz .new_gt_group_heading {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#taqpmxfwmz .new_gt_empty_group_heading {
padding: 0.5px;
color: #FFFFFF;
background-color: #222222;
font-size: 100%;
...
#taqpmxfwmz .new_gt_from_md > :first-child {
margin-top: 0;
}

#taqpmxfwmz .new_gt_from_md > :last-child {
margin-bottom: 0;
}

#taqpmxfwmz .new_gt_row {
padding-top: 7px;
padding-bottom: 7px;
padding-left: 5px;
padding-right: 5px;
...
#taqpmxfwmz .new_gt_stub_row_group {
color: #FFFFFF;
background-color: #222222;
font-size: 100%;
font-weight: initial;
...
#taqpmxfwmz .new_gt_row_group_first td {
border-top-width: 2px;
}

#taqpmxfwmz .new_gt_row_group_first th {
border-top-width: 2px;
}

#taqpmxfwmz .new_gt_summary_row {
color: #FFFFFF;
background-color: #222222;
text-transform: inherit;
padding-top: 8px;
...
#taqpmxfwmz .new_gt_first_summary_row {
border-top-style: solid;
border-top-color: #D3D3D3;
}

#taqpmxfwmz .new_gt_first_summary_row.thick {
border-top-width: 2px;
}

#taqpmxfwmz .new_gt_last_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#taqpmxfwmz .new_gt_grand_summary_row {
color: #FFFFFF;
background-color: #222222;
text-transform: inherit;
padding-top: 8px;
...
#taqpmxfwmz .new_gt_first_grand_summary_row {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#taqpmxfwmz .new_gt_last_grand_summary_row_top {
padding-top: 8px;
padding-bottom: 8px;
padding-left: 5px;
padding-right: 5px;
...
#taqpmxfwmz .new_gt_striped {
background-color: rgba(128, 128, 128, 0.05);
}

#taqpmxfwmz .new_gt_table_body {
border-top-style: none;
border-top-width: 2px;
border-top-color: #D3D3D3;
border-bottom-style: solid;
...
#taqpmxfwmz .new_gt_left {
text-align: left;
}

#taqpmxfwmz .new_gt_center {
text-align: center;
}

#taqpmxfwmz .new_gt_right {
text-align: right;
font-variant-numeric: tabular-nums;
}

#taqpmxfwmz .new_gt_font_normal {
font-weight: normal;
}

#taqpmxfwmz .new_gt_font_bold {
font-weight: bold;
}

#taqpmxfwmz .new_gt_font_italic {
font-style: italic;
}

#taqpmxfwmz .new_gt_super {
font-size: 65%;
}

#taqpmxfwmz .new_gt_footnote_marks {
font-size: 75%;
vertical-align: 0.4em;
position: initial;
}

#taqpmxfwmz .new_gt_asterisk {
font-size: 100%;
vertical-align: 0;
}

#taqpmxfwmz .new_gt_indent_1 {
text-indent: 5px;
}

#taqpmxfwmz .new_gt_indent_2 {
text-indent: 10px;
}

#taqpmxfwmz .new_gt_indent_3 {
text-indent: 15px;
}

#taqpmxfwmz .new_gt_indent_4 {
text-indent: 20px;
}

#taqpmxfwmz .new_gt_indent_5 {
text-indent: 25px;
}

#taqpmxfwmz tbody tr:last-child {
...
<th class="new_gt_col_heading new_gt_columns_bottom_border new_gt_left" rowspan="2" colspan="1" style="color: #FFFFFF; font-family: 'Titillium Web'; text-transform: uppercase; font-size: 14px; vertical-align: bottom; font-weight: 200; border-top-width: 0px; border-top-style: solid; border-top-color: #222222;" scope="col" id="Player">Player</th>
...
median_scoring_records |> 
  group_by(name) |> 
  summarize(
    placing_d = sum(orig_placing - median_placing),
    pos_d = sum(median_placing < orig_placing),
    neg_d = sum(median_placing > orig_placing)
  ) |> 
  arrange(desc(placing_d))
...
If you count things up on this slope chart, you'll see that I would have moved up in my placement in 3 out of the 6 seasons with the median ranking system. Team C would have benefited the most--they would have moved up the rankings in 4 out of the 6 seasons (and not changed in the other 2), for a total sum of +11 placements (about +2 per season). Team F is on the other end of the spectrum--they're placement would have been lower in 4 of the 6 seasons, for a total ranking change of -11 (about -2 per season).
