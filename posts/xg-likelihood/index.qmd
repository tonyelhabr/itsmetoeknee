...
maddison_uu_approach1 |> dplyr::select(player, prior_o, target_o, u)
#> # A tibble: 1 × 4
...
all_uu_approach1 |> head(10) |> dplyr::select(player, prior_o, target_o, u)
#> # A tibble: 10 × 4
#>    player             prior_o target_o       u
#>    <chr>                <dbl>    <dbl>   <dbl>
...
maddison_uu_approach2 |> dplyr::select(player, prior_o, target_o, u)
#> # A tibble: 1 × 4
#>   player         prior_o target_o     u
#>   <chr>            <dbl>    <dbl> <dbl>
...
all_uu_approach2 |> head(10) |> dplyr::select(player, prior_o, target_o, u)
#> # A tibble: 593 × 4
#>    player                    prior_o target_o     u
#>    <chr>                       <dbl>    <dbl> <dbl>
...
maddison_uu_approach3 |> dplyr::select(player, prior_o, target_o, u)
#> # A tibble: 1 × 4
#>   player         prior_o target_o     u
#>   <chr>            <dbl>    <dbl>  <dbl>
...
all_uu_approach3 |> head(10) |> dplyr::select(player, prior_o, target_o, u)
#> # A tibble: 10 × 4
#>    player           prior_o target_o         u
#>    <chr>              <dbl>    <dbl>      <dbl>
...
|----------|----------------------------------------|----------------|----------------------------------------------------|------------------------------------------------|
| 1        | Percentile Ranking                     | customizable   | subjective, sensitive to the choice of player pool | 3rd percentile                                 |
| 2        | Resampling                             | non-parametric | (relatively) computationally intensive             | 16th percentile                                |
