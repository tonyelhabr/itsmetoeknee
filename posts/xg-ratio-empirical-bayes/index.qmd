...
Finally, let's plot our results, plotting our adjusted mean estimates of $O_p$, ±1 standard deviation about the adjusted mean. As noted earlier, we won't achieve exactly the same results as Shaw due to using a different set of xG values, but evidently we've achieved results reasonably close to his.
