...
-   [Man City](https://fbref.com/en/squads/206d90db/Barcelona-Stats)--arguably the best team in the EPL for the past decade--has sustained an Elo greater than 1850 for a majority of the past decade.
...
For reproducibility, the chosen hyperparameters are as follows.[^4] By coincidence, the same hyper-parameters are chosen. (Only 50 combinations were evaluated.)
...
[^4]: This post isn't meant to be so much about the why's and how's of model tuning and training, so I've spared commentary on the code.
