...
preview: viz_diamonds_c_rnks.png
twitter:
  site: '@TonyElHabr'
  creator: '@TonyElHabr'
---
...
1.  `{vip}`'s model-specific scores with (`vip::vip(method = 'mod el')`)
2.  `{vip}`'s permutation-based scores (with `vip::vip(method = 'perm ute')`)
...
```{r fin-0, ref.label=stringr::str_subset(knitr::all_labels(), 'appendix'), echo=T, include=T, evl=F}
```
