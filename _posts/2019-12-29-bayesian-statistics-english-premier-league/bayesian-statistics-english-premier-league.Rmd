...
# ::here('content', 'post', 'bayesian-statistics-english-premier-league')
# .dir_proj <- here::here()
...
```{r setup-appendix, eval=T}
library(tidyverse)
```

```{r setup-funcs, eval=T}
...
```{r scrape-prep, eval=T}
path_epl_data <- file_path_proj('epl.xlsx')
eval_scrape <- FALSE # !fs::file_exists(path_epl_data)
```
...
```{r model_1-prep, eval=T}
path_res_sim_1 <- file_path_out('res_sim_1.rds')
eval_model_1 <- FALSE # !fs::file_exists(path_res_sim_1)
```
...
```{r path_viz_summ_1_z, eval=T}
path_viz_summ_1_z <- file_path_out('viz_summ_1_z.png')
eval_viz_summ_1_z <- FALSE # !fs::file_exists(path_viz_summ_1_z)
```
...
```{r path_viz_summ_1_z_adj, eval=T}
path_viz_summ_1_z_adj <- file_path_out('viz_summ_1_z_adj.png')
eval_viz_summ_1_z_adj <- FALSE # !fs::file_exists(path_viz_summ_1_z_adj)
```
...
```{r path_viz_conf_mat, eval=T}
path_viz_conf_mat <- file_path_out('viz_conf_mat.png')
eval_viz_conf_mat <- FALSE # !fs::file_exists(path_viz_conf_mat)
```
...
```{r path_viz_g_mode, eval=T}
path_viz_g_mode <- file_path_out('viz_g_mode.png')
eval_viz_g_mode <- FALSE # !fs::file_exists(path_viz_g_mode)
...
```{r path_viz_g_mean, eval=T}
path_viz_g_mean <- file_path_out('viz_g_mean.png')
eval_viz_g_mean <- FALSE # !fs::file_exists(path_viz_g_mean)
```
...
```{r path_viz_result_mode, eval=T}
path_viz_result_mode <- file_path_out('viz_result_mode.png')
eval_viz_result_mode <- FALSE # !fs::file_exists(path_viz_result_mode)
```
...
```{r preds_eda-show-1, include=T, echo=F}
preds_by_tm %>% 
  select(
    `Team` = tm_h,
    `# of Wins` = n,
