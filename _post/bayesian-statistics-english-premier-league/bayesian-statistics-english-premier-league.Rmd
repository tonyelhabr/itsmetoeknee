...
```{r scrape-appendix-1, include=T}
# Data Collection
seasons <- 2016L:2018L
```

```{r scrape-appendix-2, include=T}
...
```{r fin-0, ref.label=stringr::str_subset(knitr::all_labels(), 'appendix'), echo=F, include=F, eval=F}
```
