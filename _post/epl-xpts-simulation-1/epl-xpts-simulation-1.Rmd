...
tibble(
  ...
  g = c(seq_along(probs_a), seq_along(probs_b)),
...
ggsave(
  filename = '_post/epl-xpts-simulation-1/ex.png',
  width = 7,
  height = 7/1.5
)
```
...
ggsave(
  filename = '_post/epl-xpts-simulation-1/xg_vs_xpts.png',
  width = 7,
  height = 7/1.25
)
```
...
ggsave(
  filename = '_post/epl-xpts-simulation-1/calib.png',
  width = 10,
  height = 7.5
)
```
